## Create a histogram plot of Global Active Power (kilowatts) versus Frequency for the 
## electric power consumption data set from the UCI Machine Learning Database
...
## Produce the histogram and publish to plot1.png
